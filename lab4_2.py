...
def tree(x, y, n):
    ...
    ellipse(screen, light_green, (x - int(180 / n), y - int(110 / n), int(155 / n), int(100 / n)), 4)
    ellipse(screen, dark_green, (x - int(220 / n), y - int(180 / n), int(230 / n), int(120 / n)))
    ellipse(screen, light_green, (x - int(220 / n), y - int(180 / n), int(230 / n), int(120 / n)), 4)
    ellipse(screen, dark_green, (x - int(170 / n), y - int(260 / n), int(140 / n), int(160 / n)))
    ellipse(screen, light_green, (x - int(170 / n), y - int(260 / n), int(140 / n), int(160 / n)), 4)
