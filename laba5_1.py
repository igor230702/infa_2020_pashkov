...
def alien(size, x1, y1, rotated, alien_color, dead):
    ...
    x = r.randint(0, 1)
    if x == 1:
        circle(raw, yellow, (int(x1 + size / 5 + size / 2.1), int(y1 + size / 5.2)), int(size / 18))
        circle(raw, yellow, (int(x1 + size / 5 + size / 1.8), int(y1 + size / 5.9)), int(size / 13))
        circle(raw, yellow, (int(x1 + size / 5 + size / 1.6), int(y1 + size / 5.75)), int(size / 15))
        circle(raw, black, (int(x1 + size / 5 + size / 1.45), int(y1 + size / 5.75)), int(size / 43))
    else:
    ...
    ellipse(surf0, leaf_green, (0, 0, size / 15, size / 22.5))
